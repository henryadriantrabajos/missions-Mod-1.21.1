...
@Mod(MisionesComarca.MOD_ID)
public class MisionesComarca {
    public static final String MOD_ID = "misionescomarcamod";
    public static final Logger LOGGER = LoggerFactory.getLogger(MisionesComarca.class);
    ...
    private void onReloadListeners(AddReloadListenerEvent event) {
        event.addListener(new MisionesJsonLoader());
    }
